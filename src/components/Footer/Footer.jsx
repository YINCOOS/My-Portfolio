  ...
  return (
    <footer>
      ...
      <div className="footer__socials">
        <a href="https://github.com/YINCOOS" target="_blank" rel="noreferrer">
          <BsGithub />
        </a>
        <a
          href="https://www.linkedin.com/in/adeyinka-david-ogunsemoyin-7a32051ba/"
          target="_blank"
          rel="noreferrer"
        >
          <ImLinkedin />
        ...
        <a
          href="https://msng.link/o/?YINCOOS=tg"
          target="_blank"
          rel="noreferrer"
        >
          <FaTelegramPlane />
